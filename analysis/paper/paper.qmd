---
title: "Model averaging probability distributions and the inversion principle"
author:
  - name: "David Fox"
    corresponding: true
...
highlights: |
  This paper describes how standard model averaging of the percentiles of probability distributions violates the inversion principle and defines the method that satisfies the principle.
---
...
# Introduction
Probability distributions are widely used in many fields of science to provide estimates that are critical for scientific inference, and more importantly in a range of decision science frameworks. 
For example, species sensitivity distributions (SSD) are widely used in Australia, New Zealand, North America, and Europe to determine concentrations of toxicants that are protective of most species within an ecosystem.
In this case regulators are typically interested in the lower tails of the distributions, such as the 1st, 5th and 10th percentiles, such that toxicants below these levels are assumed to be protective of 99, 95 and 90% of the species in ecosystem.
